...
def view_children_films():
    children_rating = ('G', 'G')
    json_movie_info = get_films_by_parameters('query_rating', FORMATTERS['rating']['children'], children_rating)
...
def view_family_films():
    ...
    json_movie_info = get_films_by_parameters('query_rating', FORMATTERS['rating']['family'], family_rating)
    return jsonify(json_movie_info)
...
def view_adult_films():
    ...
    json_movie_info = get_films_by_parameters('query_rating', FORMATTERS['rating']['adult'], adult_rating)
    return jsonify(json_movie_info)
